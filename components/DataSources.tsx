      ...
      <div className="space-y-6">
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-slate-600 mt-1 text-sm">Real-time blockchain verification via Arbiscan API</p>
          </div>
        </div>
        ...
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-slate-600 mt-1 text-sm">Blockchain transparency for every transaction</p>
          </div>
        </div>
      </div>
