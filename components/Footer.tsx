          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-sm text-slate-500 max-w-xs">
                Independent guidance to help you select the best prop firm for you.
              </p>
            </div>
            <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li><button onClick={() => navigateTo('trading-tools')} className="text-slate-500 hover:text-teal-600 transition-colors">Trading Tools</button></li>
                <li><button onClick={() => navigateTo('analytics')} className="text-slate-500 hover:text-teal-600 transition-colors">Analytics</button></li>
