...
const ArticleCard: React.FC<ArticleCardProps> = ({ article, viewArticle }) => {
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-xl overflow-hidden group shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
      {/* Image with overlay */}
      ...
      <div className="p-6">
        ...
        <button 
          ...
          className="w-full inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-gradient-to-r from-teal-500 to-slate-900 hover:from-teal-600 hover:to-slate-800 transition-all duration-300 group/btn"
        >
