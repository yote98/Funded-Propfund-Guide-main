    ...
    <div className="space-y-8">
      ...
      <div className="text-center mb-8">
        <div className="flex items-center justify-center mb-2">
          <img
            src="/images/icons/clock-3d.png"
            alt="Market Timing"
            className="w-8 h-8 mr-3 drop-shadow"
            draggable={false}
          />
          <h2 className="text-3xl font-bold text-slate-900">Market Timing Insights</h2>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
          <div className="flex items-center gap-2 mb-4">
            <img
              ...
              draggable={false}
            />
            <h3 className="text-xl font-semibold text-slate-900">Best Trading Times by Market</h3>
          </div>
