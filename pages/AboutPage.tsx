    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="bg-white border border-slate-200 rounded-xl shadow-md p-8 mb-12">
        <div className="prose prose-lg text-slate-700 max-w-none space-y-4">
          ...
          <p>
            Founded in 2025, Funded Program Guide has come a long way from its beginnings. When we first started out, our passion for helping other traders find legitimate and fair funding opportunities drove us to do intense research, and gave us the impetus to turn hard work and inspiration into a booming online resource. Now in 2025, we serve traders all over the world, and are thrilled to be a part of the fair-trade wing of the proprietary trading industry.
          </p>
