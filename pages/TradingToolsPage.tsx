...
import TradingToolsIcon from '../components/icons/TradingToolsIcon';
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-8">
        <div className="flex items-center justify-center mb-4">
          <img
            src="/images/icons/tools-3d.png"
            alt="Trading Tools"
            className="w-12 h-12 mr-3 drop-shadow"
            draggable={false}
          />
          <h1 className="text-4xl font-bold text-slate-900">Trading Tools</h1>
        </div>
                      ...
                      <div className="w-16 h-16 bg-white rounded-lg p-2 border border-slate-200 mr-4 flex-shrink-0">
                        <Logo firmName={tool.name} logoUrl={tool.logoUrl} className="w-full h-full object-contain" />
                          ...
                          <div className="min-w-0">
                            <div className="flex items-center text-sm font-semibold text-slate-900 truncate">{tool.name}</div>
                ...
                <div className="w-16 h-16 bg-white rounded-lg p-2 border border-slate-200 flex-shrink-0">
                  <Logo firmName={tool.name} logoUrl={tool.logoUrl} className="w-full h-full object-contain" />
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center text-sm font-semibold text-slate-900">{tool.name}</div>
