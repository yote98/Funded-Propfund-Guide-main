  ...
  return (
    <div className="space-y-16">
      ...
      <section id="featured-firms">
        <h2 className="text-3xl font-bold text-slate-900 text-center mb-8">Featured Firms</h2>
      ...
      <section id="top-deals">
        <h2 className="text-3xl font-bold text-slate-900 text-center mb-2">Top {currentMonth} Deals</h2>
