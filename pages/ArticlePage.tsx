...
const ArticlePage: React.FC<ArticlePageProps> = ({ article, navigateToEducation }) => {
  ...
  const handleMoreArticles = () => {
    if (navigateToEducation) {
      navigateToEducation();
    } else {
      // Fallback: navigate to education page
      window.history.pushState({ page: 'education' }, '', '/education');
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <button 
              ...
              className="inline-flex items-center px-4 py-2 border border-transparent rounded-lg text-sm font-medium text-white bg-gradient-to-r from-teal-500 to-slate-900 hover:from-teal-600 hover:to-slate-800 transition-all duration-300"
            >
