...
const AnalyticsPage: React.FC<AnalyticsPageProps> = ({ firms, reviews }) => {
  ...
  const tabs = [
    ...
    { id: 'costs', label: 'Cost Analysis', icon: '💰', customIcon: '/images/icons/money-3d.png' },
    { id: 'success', label: 'Success Metrics', icon: '🏆' },
    { id: 'timing', label: 'Market Timing', icon: '⏰', customIcon: '/images/icons/clock-3d.png' },
      ...
      <div className="text-center mb-8">
        <div className="flex items-center justify-center mb-4">
          <img
            ...
            alt="Data Analytics"
            className="w-10 h-10 mr-3 drop-shadow"
            draggable={false}
          />
