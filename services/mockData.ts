...
export const propFirms: PropFirm[] = [
  // Forex/CFD-Focused Firms
  {
    ...
    regulatoryCompliance: 'FCA Regulated',
    industryAwards: ['Best Prop Firm 2023', 'Trading Excellence Award'],
    socialProof: {
  ...
  },
  {
    ...
    // Trust & Credibility Metrics
    trustScore: 4.8,
    trustedByUsers: 18000,
    regulatoryCompliance: 'ISO Certified',
    industryAwards: ['Best Scaling Program 2024', 'Innovation in Trading Award'],
    socialProof: {
    ...
    // Enhanced Data
    payoutHistory: {
      totalPayouts: 85000000,
      averagePayoutTime: 'Bi-weekly',
      payoutReliability: 'Excellent',
    ...
    trustedByUsers: 8500,
    regulatoryCompliance: 'FCA Regulated',
    industryAwards: ['Best VIP Program 2024', 'Excellence in Coaching'],
    socialProof: {
  ...
  },
  {
    ...
    trustScore: 3.8,
    trustedByUsers: 4200,
    regulatoryCompliance: 'Limited Regulation',
    industryAwards: ['Best EA Support 2024'],
    socialProof: {
  ...
  },
  {
    ...
    trustedByUsers: 3200,
    regulatoryCompliance: 'FCA Regulated',
    industryAwards: ['Best UK Prop Firm 2024'],
    socialProof: {
    ...
    // Trust & Credibility Metrics
    trustScore: 4.9,
    trustedByUsers: 50000,
    verificationStatus: 'verified',
    regulatoryCompliance: 'Fully Regulated',
    industryAwards: ['#1 Prop Firm 2024', 'Best Trading Platform', 'Innovation Award'],
    socialProof: {
  ...
  },
  {
    ...
    // Trust & Credibility Metrics
    trustScore: 4.6,
    trustedByUsers: 12000,
    regulatoryCompliance: 'ISO 27001 Certified',
    industryAwards: ['Fastest Payout Award 2024', 'Best Customer Service'],
    socialProof: {
    ...
    // Trust & Credibility Metrics
    trustScore: 4.7,
    trustedByUsers: 15000,
    regulatoryCompliance: 'FCA Regulated',
    industryAwards: ['Best EA-Friendly Firm 2024', 'Excellence in Customer Support'],
    socialProof: {
    ...
    trustedByUsers: 5800,
    regulatoryCompliance: 'Limited Regulation',
    industryAwards: ['Best Salary Program 2024', 'Innovation in Compensation'],
    socialProof: {
  ...
  },
  {
    ...
    trustScore: 3.7,
    trustedByUsers: 2800,
    regulatoryCompliance: 'Eightcap Backed',
    industryAwards: ['Best Niche Trading 2024'],
    socialProof: {
  ...
  },
  {
    ...
    // Trust & Credibility Metrics
    trustScore: 4.5,
    trustedByUsers: 25000,
    regulatoryCompliance: 'DFSA Regulated',
    industryAwards: ['Best for Beginners 2024', 'Fastest Growing Prop Firm'],
    socialProof: {
  ...
  },
  {
    ...
    minStartingCost: 100,
    geoRestrictions: 'Available worldwide.',
    overview: 'Maven Trading pairs 1/2-step evaluations with mentorship resources, bi-weekly payouts, and MT4/MT5 support, aiming to serve community-focused traders.',
    sources: ["Official site"],
    verificationStatus: 'unverified',
    lastVerifiedAt: '2025-10-14',
    ...
    trustedByUsers: 4500,
    regulatoryCompliance: 'Limited Regulation',
    industryAwards: ['Best Mentorship Program 2024', 'Community Excellence Award'],
    socialProof: {
  ...
  },
  {
    ...
    minStartingCost: 27,
    geoRestrictions: 'Available worldwide.',
    overview: 'Blue Guardian offers low entry costs and the Guardian Shield equity protection tool, with weekly payouts and MT4/MT5/cTrader platform support.',
    sources: ["Official site", "TheTrustedProp"],
    verificationStatus: 'partial',
    lastVerifiedAt: '2025-10-14',
    ...
    trustedByUsers: 6800,
    regulatoryCompliance: 'FCA Regulated',
    industryAwards: ['Innovation in Risk Management 2024', 'Best Guardian Shield Feature'],
    socialProof: {
  ...
  // Futures-Focused Firms
  {
    ...
    // Trust & Credibility Metrics
    trustScore: 4.8,
    trustedByUsers: 35000,
    regulatoryCompliance: 'NFA Member',
    industryAwards: ['#1 Futures Prop Firm 2024', 'Best Discount Program', 'Trader Choice Award'],
    socialProof: {
      trustpilotRating: 4.7,
      googleRating: 4.6,
      redditMentions: 6800,
    ...
    payoutHistory: {
      ...
      averagePayoutTime: 'Every 8 days',
      payoutReliability: 'Excellent',
      lastUpdated: '2025-10-15'
    },
    ...
    // Trust & Credibility Metrics
    trustScore: 4.7,
    trustedByUsers: 22000,
    regulatoryCompliance: 'NFA Member',
    industryAwards: ['Best Educational Platform 2024', 'Pioneer in Prop Trading', 'Excellence in Coaching'],
    socialProof: {
      trustpilotRating: 4.6,
      googleRating: 4.5,
      redditMentions: 4500,
    ...
    // Enhanced Data
    payoutHistory: {
      totalPayouts: 80000000,
      averagePayoutTime: 'Daily',
      payoutReliability: 'Excellent',
      lastUpdated: '2025-10-15'
    },
  ...
  },
  {
    ...
    trustedByUsers: 7200,
    regulatoryCompliance: 'NFA Member',
    industryAwards: ['Fastest Payouts 2024', 'Best for Scalpers'],
    socialProof: {
    ...
    trustedByUsers: 3800,
    regulatoryCompliance: 'Limited Regulation',
    industryAwards: ['Best Lightning Program 2024', 'Innovation in Instant Funding'],
    socialProof: {
      trustpilotRating: 3.8,
      googleRating: 3.7,
      redditMentions: 700,
    ...
    trustedByUsers: 12000,
    regulatoryCompliance: 'NFA Member',
    industryAwards: ['Best Daily Payouts 2024', 'Excellence in Automation'],
    socialProof: {
      trustpilotRating: 4.4,
      googleRating: 4.3,
      redditMentions: 2800,
  ...
  },
  {
    ...
    trustedByUsers: 9500,
    regulatoryCompliance: 'NFA Member',
    industryAwards: ['Best for Beginners 2024', 'Excellence in Customer Support'],
    socialProof: {
      trustpilotRating: 4.2,
      googleRating: 4.1,
      redditMentions: 2100,
  ...
  },
  {
    ...
    // Trust & Credibility Metrics
    trustScore: 4.4,
    trustedByUsers: 11000,
    regulatoryCompliance: 'NFA Member',
    industryAwards: ['Best Pro+ Program 2024', 'Excellence in Real Fund Trading'],
    socialProof: {
      trustpilotRating: 4.3,
      googleRating: 4.2,
      redditMentions: 2400,
    ...
    trustedByUsers: 7800,
    regulatoryCompliance: 'NFA Member',
    industryAwards: ['Best Discount Program 2024', 'Excellence in Algo Trading'],
    socialProof: {
      trustpilotRating: 4.0,
      googleRating: 3.9,
      redditMentions: 1600,
    ...
    trustedByUsers: 5200,
    regulatoryCompliance: 'NFA Member',
    industryAwards: ['Best Discount Program 2024', 'Excellence in Profit Sharing'],
    socialProof: {
      trustpilotRating: 3.9,
      googleRating: 3.8,
      redditMentions: 1100,
    ...
    trustScore: 3.8,
    trustedByUsers: 1800,
    regulatoryCompliance: 'Funding Pips Backed',
    industryAwards: ['Best New Entrant 2025', 'Innovation in Zero-Challenge'],
    socialProof: {
      trustpilotRating: 3.7,
      googleRating: 3.6,
      redditMentions: 400,
  ...
  },
  {
    ...
    trustedByUsers: 2400,
    regulatoryCompliance: 'Limited Regulation',
    industryAwards: ['Best Live Onboarding 2024'],
    socialProof: {
  ...
  },
  {
    ...
    trustedByUsers: 6200,
    regulatoryCompliance: 'NFA Member',
    industryAwards: ['Fastest Payouts 2024', 'Best Direct Account Program'],
    socialProof: {
      trustpilotRating: 4.1,
      googleRating: 4.0,
      redditMentions: 1400,
    ...
    overview: 'Purdia is a very new forex-focused firm with standard 1/2-step evaluations on MT4/MT5 and a marketing emphasis on free resets and collaborative scaling. Independent data is limited; assess carefully.',
    sources: ["Official site"],
    verificationStatus: 'unverified',
    lastVerifiedAt: '2025-10-14',
    ...
    trustedByUsers: 800,
    regulatoryCompliance: 'Limited Regulation',
    industryAwards: ['Best Free Resets 2025'],
    socialProof: {
  ...
  },
  {
    ...
    shortName: 'Goat',
    logoUrl: '/logos/goat-funded-trader.png',
  ...
  },
  {
    ...
    name: 'Aqua Funded',
    shortName: 'Aqua',
    logoUrl: '/logos/aqua-funded.png',
    officialWebsite: 'https://aquafunded.com',
    tagline: 'Liquid Capital, Solid Results',
    shortDescription: 'Highly-rated prop firm with 77 verified reviews on TradingPilot, known for excellent trader support and transparent evaluation process.',
    rating: 4.8,
    reviewCount: 77,
    ...
    evaluationProcessSummary: 'Traditional 2-step evaluation with transparent rules and excellent trader support throughout the process.',
    minStartingCost: 99,
    geoRestrictions: 'Available worldwide.',
    overview: 'Aqua Funded has earned a stellar reputation with 77 verified reviews and a 4.8 rating on TradingPilot. They focus on trader education and support, with a transparent evaluation process and weekly payouts.',
    sources: ["TradingPilot"],
    verificationStatus: 'verified',
    lastVerifiedAt: '2025-10-15',
    pros: ["Excellent trader support", "Weekly payouts", "Transparent rules", "High TradingPilot rating"],
    cons: ["Limited funding models", "Higher minimum starting cost"],
    details: { minFunding: 25000, maxFunding: 300000, profitSplit: 85, maxDrawdown: 8, dailyDrawdown: 4, profitTarget: 10, minTradingDays: 5 },
    features: { scalingPlan: true, weekendHolding: true, newsTrading: true, expertAdvisors: true, fastPayouts: true, noTimeLimit: false },
    payoutHistory: {
      totalPayouts: 0,
      averagePayoutTime: 'Weekly',
  ...
  },
  {
    ...
    name: 'Fundora',
    shortName: 'Fundora',
    logoUrl: '/logos/fundora.png',
    officialWebsite: 'https://international.fundora-trading.com/',
    tagline: 'Japan\'s Premier Prop Trading Firm',
    shortDescription: 'A Japanese prop firm offering up to $400,000 in demo funds with a two-phase evaluation process and 80% profit split.',
    rating: 4.3,
    reviewCount: 310,
    affiliateUrl: 'https://international.fundora-trading.com/?ref=FPG',
    fpgAffiliateCode: 'FPG',
    hasInstantFunding: false,
    isUSFriendly: false,
    fundingModels: ['2-Step Challenge'],
    tradingInstruments: ['Forex', 'Metals', 'Indices', 'Crypto'],
    categories: ['Forex/CFD', 'Crypto'],
    payoutFrequency: 'Monthly',
    drawdownType: 'Static',
    platforms: ['cTrader'],
    ...
    // Company Information
    countryFounded: 'Japan',
    yearsInOperation: 4,
    foundedYear: 2021,
    headquarters: 'Tokyo, Japan',
    
    evaluationProcessSummary: 'Two-phase challenge: Phase 1 requires 8% profit target, Phase 2 requires 5% profit target. Both phases have 5% daily drawdown and 10% max drawdown limits. No time limit for completion.',
    minStartingCost: 177,
    geoRestrictions: 'Available worldwide, Japanese interface primary.',
    overview: 'Established in March 2025, Fundora is a Japanese prop trading firm that offers account sizes up to $400,000 with an 80% profit split. Their evaluation process has no time limit, and they provide gold swap-free trading. Fundora also offers an educational platform to help traders develop their skills.',
    sources: ["PayoutJunction"],
    verificationStatus: 'verified',
    lastVerifiedAt: '2025-10-15',
    pros: ["Japanese market focus", "High maximum funding up to $400K", "Gold swap-free trading", "No time limit on evaluation", "Educational resources"],
    cons: ["Monthly payouts slower than competitors", "Higher entry costs starting at $177"],
    details: { minFunding: 16666, maxFunding: 400000, profitSplit: 80, maxDrawdown: 10, dailyDrawdown: 5, profitTarget: 8, minTradingDays: 3 },
    features: { scalingPlan: true, weekendHolding: true, newsTrading: true, expertAdvisors: true, fastPayouts: false, noTimeLimit: true },
    payoutHistory: {
      totalPayouts: 0,
      averagePayoutTime: 'Monthly',
    ...
    platformDetails: [
      {
        name: 'cTrader',
        type: 'cTrader',
        features: ['Multi-Asset Trading', 'Advanced Charting', 'Algorithmic Trading', 'Depth of Market'],
        mobileSupport: true,
        webTrading: true
      }
    ]
