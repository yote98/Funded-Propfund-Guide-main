...
export const propFirms: PropFirm[] = [
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 5000, // Adjusted from 18000
    isFeatured: true,
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 7500, // Adjusted from 28000
    isFeatured: true,
    ...
    // Futures-Focused Firms
  {
    ...
    rating: 4.7,
    reviewCount: 3500, // Adjusted from 13000
    isFeatured: true,
...
export const articles: Article[] = [
  ...
  },
  {
    ...
    content: `
      ...
      <h2>Step 2: Preparing for Success</h2>
      <h3>Develop Your Trading Skills</h3>
      <p>Before attempting any prop firm evaluation, ensure you have:</p>
      <ul>
      ...
      <p>Before paying for an evaluation:</p>
      <ul>
      ...
      <h2>Step 3: Choosing Your First Prop Firm</h2>
      ...
      <h3>Recommended Starting Firms</h3>
      ...
      <h2>Step 4: The Evaluation Process</h2>
      <h3>Understanding the Challenge</h3>
      <p>Most prop firms use a two-step evaluation process:</p>
      
      <h4>Phase 1: Profit Target</h4>
      <ul>
      ...
      <h2>Step 5: Managing Your Funded Account</h2>
      <h3>First Month Guidelines</h3>
      <p>Once you receive your funded account:</p>
      <ul>
      ...
      <h3>Building Your Track Record</h3>
      <ul>
      ...
      <h2>Step 6: Scaling and Growth</h2>
      <h3>When to Scale</h3>
      <p>Consider scaling when you have:</p>
      <ul>
      ...
      <h3>Week 1-2: Education and Preparation</h3>
      <ul>
      ...
      <h3>Week 3-4: Strategy Testing</h3>
      <ul>
        <li>Backtest your strategy thoroughly</li>
      ...
      <h3>Month 2: First Evaluation</h3>
      <ul>
      ...
      <h3>Month 3+: Building Success</h3>
      <ul>
      ...
      <p>Prop trading can be a life-changing opportunity, but it requires preparation, discipline, and patience. Success doesn't happen overnight, but with the right approach, you can build a sustainable trading career with funded capital.</p>
      
      <p><strong>Remember:</strong> The key to success in prop trading is not making the most money quickly, but making consistent profits while managing risk effectively. Focus on building a sustainable system that works across different market conditions, and the profits will follow naturally.</p>
      
      <p>Good luck on your prop trading journey! 🚀</p>
    `
  }
];
