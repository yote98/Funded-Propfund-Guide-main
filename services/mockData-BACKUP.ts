...
export const propFirms: PropFirm[] = [
  // Forex/CFD-Focused Firms
  {
    ...
    sources: ['TradingPilot.net', 'Finance Magnates', 'Direct firm verification'],
  ...
  // Futures-Focused Firms
  {
    ...
    shortName: 'Apex',
    logoUrl: 'https://apextraderfunding.com/logos',
  ...
  },
  {
    ...
    shortName: 'Top One',
    logoUrl: '/logos/top-one-futures.png',
  ...
  // removed: my-funded-futures
  {
    id: 'blusky-trading',
    name: 'BluSky Trading',
    shortName: 'BluSky',
    logoUrl: 'https://logo.clearbit.com/blusky.pro',
  ...
  // Additional Reputable Firms
  {
    id: 'earn2trade',
    name: 'Earn2Trade',
    shortName: 'Earn2Trade',
    logoUrl: 'https://logo.clearbit.com/earn2trade.com',
    officialWebsite: 'https://earn2trade.com/',
    tagline: 'Educational Futures Trading',
    shortDescription: 'Educational-focused futures prop firm with structured learning programs and funding opportunities.',
    rating: 4.5,
    reviewCount: 2000,
    affiliateUrl: 'https://earn2trade.com/?ref=FPG',
    fpgAffiliateCode: 'FPG',
    hasInstantFunding: false,
    isUSFriendly: true,
    fundingModels: ['Gauntlet Mini', 'Gauntlet'],
    tradingInstruments: ['Futures'],
    categories: ['Futures'],
    payoutFrequency: 'Bi-weekly',
    drawdownType: 'Trailing',
    evaluationProcessSummary: 'Offers educational programs with structured evaluations designed to teach proper risk management and trading discipline.',
    minStartingCost: 49,
    geoRestrictions: 'Available worldwide.',
    overview: 'Earn2Trade is a unique prop firm that combines education with funding opportunities. They offer structured learning programs that teach proper risk management and trading discipline, making them ideal for beginners who want to learn while earning.',
    pros: ["Strong educational focus", "Structured learning programs", "Good for beginners", "US-friendly"],
    cons: ["Educational approach may be slower than direct funding"],
    details: { minFunding: 25000, maxFunding: 150000, profitSplit: 80, maxDrawdown: 6, dailyDrawdown: 0, profitTarget: 6, minTradingDays: 10 },
    features: { scalingPlan: true, weekendHolding: false, newsTrading: true, expertAdvisors: false, fastPayouts: true, noTimeLimit: true },
    sources: ['TradingPilot.net', 'Finance Magnates', 'Direct firm verification'],
    verificationStatus: 'verified',
    lastVerifiedAt: '2024-12-19',
  },
  {
    ...
    name: 'OneUp Trader',
    shortName: 'OneUp',
    logoUrl: 'https://logo.clearbit.com/oneuptrader.com',
    officialWebsite: 'https://oneuptrader.com/',
    tagline: 'Futures Funding with Scaling',
    shortDescription: 'Futures-focused prop firm offering scaling programs and educational resources for traders.',
    rating: 4.4,
    reviewCount: 1500,
    affiliateUrl: 'https://oneuptrader.com/?ref=FPG',
    fpgAffiliateCode: 'FPG',
    hasInstantFunding: false,
    isUSFriendly: true,
    fundingModels: ['1-Step Challenge', '2-Step Challenge'],
    ...
    payoutFrequency: 'Weekly',
    drawdownType: 'Trailing',
    evaluationProcessSummary: 'Offers 1 and 2-step evaluations with a focus on futures trading and scaling successful traders.',
    minStartingCost: 99,
    geoRestrictions: 'Available worldwide.',
    overview: 'OneUp Trader is a futures-focused prop firm that offers scaling programs for successful traders. They provide educational resources and have a good reputation for supporting trader development.',
    pros: ["Futures-focused", "Scaling programs", "Educational resources", "Good reputation"],
    cons: ["Limited to futures trading only"],
    details: { minFunding: 25000, maxFunding: 300000, profitSplit: 90, maxDrawdown: 6, dailyDrawdown: 0, profitTarget: 6, minTradingDays: 5 },
    features: { scalingPlan: true, weekendHolding: false, newsTrading: true, expertAdvisors: false, fastPayouts: true, noTimeLimit: true },
    sources: ['TradingPilot.net', 'Finance Magnates', 'Direct firm verification'],
    verificationStatus: 'verified',
    lastVerifiedAt: '2024-12-19',
  },
  {
    id: 'surge-trader',
    name: 'SurgeTrader',
    shortName: 'SurgeTrader',
    logoUrl: 'https://logo.clearbit.com/surgetrader.com',
    officialWebsite: 'https://surgetrader.com/',
    tagline: 'US-Focused Trading Firm',
    shortDescription: 'US-focused prop firm offering forex and futures trading with competitive profit splits.',
    rating: 4.3,
    reviewCount: 800,
    affiliateUrl: 'https://surgetrader.com/?ref=FPG',
    fpgAffiliateCode: 'FPG',
    hasInstantFunding: false,
    isUSFriendly: true,
    fundingModels: ['1-Step Challenge', '2-Step Challenge'],
    ...
    payoutFrequency: 'Weekly',
    drawdownType: 'Static',
    evaluationProcessSummary: 'Offers 1 and 2-step evaluations with a focus on US traders and competitive profit splits.',
    minStartingCost: 99,
    geoRestrictions: 'US-focused but available worldwide.',
    overview: 'SurgeTrader is a US-focused prop firm that offers both forex and futures trading opportunities. They have competitive profit splits and are known for their support of US traders.',
    pros: ["US-focused", "Competitive profit splits", "Both forex and futures", "Good for US traders"],
    cons: ["Newer firm with limited history"],
    details: { minFunding: 10000, maxFunding: 200000, profitSplit: 90, maxDrawdown: 8, dailyDrawdown: 4, profitTarget: 8, minTradingDays: 5 },
    features: { scalingPlan: true, weekendHolding: true, newsTrading: true, expertAdvisors: true, fastPayouts: true, noTimeLimit: true },
    sources: ['TradingPilot.net', 'Finance Magnates', 'Direct firm verification'],
    verificationStatus: 'verified',
    lastVerifiedAt: '2024-12-19',
  ...
  {
    id: 'traders-with-edge',
    name: 'Traders With Edge',
    shortName: 'TWE',
    logoUrl: 'https://logo.clearbit.com/traderswithedge.com',
    officialWebsite: 'https://traderswithedge.com/',
    tagline: 'Educational Trading Programs',
    shortDescription: 'Educational-focused prop firm combining trading education with funding opportunities.',
    rating: 4.2,
    reviewCount: 600,
    affiliateUrl: 'https://traderswithedge.com/?ref=FPG',
    fpgAffiliateCode: 'FPG',
    hasInstantFunding: false,
    isUSFriendly: true,
    fundingModels: ['1-Step Challenge', '2-Step Challenge'],
    ...
    payoutFrequency: 'Bi-weekly',
    drawdownType: 'Static',
    evaluationProcessSummary: 'Offers educational programs combined with evaluation challenges to teach proper trading techniques.',
    minStartingCost: 97,
    geoRestrictions: 'Available worldwide.',
    overview: 'Traders With Edge combines education with funding opportunities, offering structured programs that teach proper trading techniques while providing access to funded accounts.',
    pros: ["Educational focus", "Structured programs", "Good for learning", "US-friendly"],
    cons: ["Educational approach may be slower"],
    details: { minFunding: 10000, maxFunding: 100000, profitSplit: 80, maxDrawdown: 10, dailyDrawdown: 5, profitTarget: 10, minTradingDays: 5 },
    features: { scalingPlan: true, weekendHolding: true, newsTrading: true, expertAdvisors: true, fastPayouts: false, noTimeLimit: true },
    sources: ['TradingPilot.net', 'Finance Magnates', 'Direct firm verification'],
    verificationStatus: 'verified',
    lastVerifiedAt: '2024-12-19',
  },
  {
    ...
    name: 'Tradiac',
    shortName: 'Tradiac',
    logoUrl: 'https://logo.clearbit.com/tradiac.com',
    officialWebsite: 'https://tradiac.com/',
    tagline: 'European Multi-Asset Firm',
    shortDescription: 'European prop firm offering multi-asset trading with strong payout record.',
    rating: 4.4,
    reviewCount: 1200,
    affiliateUrl: 'https://tradiac.com/?ref=FPG',
    fpgAffiliateCode: 'FPG',
    hasInstantFunding: false,
    isUSFriendly: false,
    fundingModels: ['1-Step Challenge', '2-Step Challenge'],
    ...
    payoutFrequency: 'Weekly',
    drawdownType: 'Static',
    evaluationProcessSummary: 'Offers 1 and 2-step evaluations with a focus on European traders and multi-asset trading.',
    minStartingCost: 99,
    geoRestrictions: 'European-focused, limited US access.',
    overview: 'Tradiac is a European prop firm with a strong payout record and multi-asset trading capabilities. They offer competitive profit splits and have built a solid reputation in the European market.',
    pros: ["Strong payout record", "Multi-asset trading", "Competitive profit splits", "European focus"],
    cons: ["Limited US access", "European-focused"],
    details: { minFunding: 10000, maxFunding: 200000, profitSplit: 85, maxDrawdown: 8, dailyDrawdown: 4, profitTarget: 8, minTradingDays: 5 },
    features: { scalingPlan: true, weekendHolding: true, newsTrading: true, expertAdvisors: true, fastPayouts: true, noTimeLimit: true },
    sources: ['TradingPilot.net', 'Finance Magnates', 'Direct firm verification'],
    verificationStatus: 'verified',
    lastVerifiedAt: '2024-12-19',
